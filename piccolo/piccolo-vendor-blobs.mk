...
PRODUCT_COPY_FILES += \
    ...
    vendor/bq/piccolo/proprietary/bin/cnd:system/bin/cnd \
    vendor/bq/piccolo/proprietary/etc/cne/andsfCne.xml:system/etc/cne/andsfCne.xml \
    ...
    vendor/bq/piccolo/proprietary/vendor/lib/libcneqmiutils.so:system/vendor/lib/libcneqmiutils.so \
    vendor/bq/piccolo/proprietary/vendor/lib/libmasc.so:system/vendor/lib/libmasc.so \
    vendor/bq/piccolo/proprietary/vendor/lib/libvendorconn.so:system/vendor/lib/libvendorconn.so \
    vendor/bq/piccolo/proprietary/vendor/lib/libwqe.so:system/vendor/lib/libwqe.so \
    vendor/bq/piccolo/proprietary/bin/dpmd:system/bin/dpmd \
    vendor/bq/piccolo/proprietary/etc/dpm/nsrm/NsrmConfiguration.xml:system/etc/dpm/nsrm/NsrmConfiguration.xml \
    vendor/bq/piccolo/proprietary/etc/permissions/dpmapi.xml:system/etc/permissions/dpmapi.xml \
    vendor/bq/piccolo/proprietary/vendor/lib/libdpmctmgr.so:system/vendor/lib/libdpmctmgr.so \
    vendor/bq/piccolo/proprietary/vendor/lib/libdpmfdmgr.so:system/vendor/lib/libdpmfdmgr.so \
    vendor/bq/piccolo/proprietary/vendor/lib/libdpmframework.so:system/vendor/lib/libdpmframework.so \
    vendor/bq/piccolo/proprietary/vendor/lib/libdpmnsrm.so:system/vendor/lib/libdpmnsrm.so \
